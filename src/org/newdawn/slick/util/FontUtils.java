...
public class FontUtils
{
	...
	/**
	 * Draws justified-space separated substrings based on the given {@link String} and the given starting x and y coordinates to the given {@link Graphics2D} instance.
	 * 
	 * @param font
